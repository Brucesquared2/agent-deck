...
| shared agent contracts | Behavioral boundaries for agents |

## 7. Memory system

### 7.1 Memory classes

The memory system must distinguish at minimum:
...
- **[DECISION]** A recovery manifest schema must be established before large-scale orchestration work.
...
## 12. Provisional authority artifacts

The following are provisional authority artifacts:

- `WAREHOUSE_SPECIFICATION.md` (this file)
- `WAREHOUSE_AUTHORITY_MAP.json`
- `LINEAGE_SCHEMA.json`
- `RECOVERY_MANIFEST_SCHEMA.json`
...
- [ ] Dual taxonomy unresolved
- [ ] Dual Signal format unresolved
- [ ] Missing lineage schema
- [ ] Missing recovery manifest schema
- [ ] Incomplete authority-map formalization
- [ ] Specification not yet blessed by operator
