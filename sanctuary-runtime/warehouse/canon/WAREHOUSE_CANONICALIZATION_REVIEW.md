...
| File | Role |
|------|------|
| `WAREHOUSE_SPECIFICATION.md` | Root authority |
...
| File | Role |
|------|------|
| `00-core/policies.md` | Write authority rules |
| `50-maps/MEMORY_MAP.md` | Taxonomy authority |
| `60-signals/signal-lang.md` | Signal format authority |
| `60-signals/signal-schema.json` | Signal payload validation |
...
1. Publish a migration/deprecation note (see `TAXONOMY_MIGRATION_PLAN.md`, `SIGNAL_LANG_MIGRATION_PLAN.md`, `DEPRECATION_POLICY.md`)
...
Answer each item with **YES** or **NO**. Sign and date at the bottom.

---

**Q1.** Approve `WAREHOUSE_SPECIFICATION.md` as provisional candidate authority?

`[ ] YES  [ ] NO`

---

**Q2.** Approve `WAREHOUSE_AUTHORITY_MAP.json` as provisional authority map?

`[ ] YES  [ ] NO`

---

**Q3.** Approve `LINEAGE_SCHEMA.json` as provisional lineage contract?

`[ ] YES  [ ] NO`

---

**Q4.** Approve `RECOVERY_MANIFEST_SCHEMA.json` as provisional recovery contract?

`[ ] YES  [ ] NO`

---

**Q5.** Approve numbered taxonomy (00–90) as default canonical memory tree?

`[ ] YES  [ ] NO`

---

**Q6.** Approve versioned `60-signals` format as default canonical Signal format?

`[ ] YES  [ ] NO`

---

**Q7.** Grandfather legacy unnumbered taxonomy temporarily (no immediate deletion)?

`[ ] YES  [ ] NO`

---

**Q8.** Grandfather legacy `.signal` format temporarily (no immediate deletion)?

`[ ] YES  [ ] NO`

---

**Q9.** Require explicit migration/deprecation note before parser implementation?

`[ ] YES  [ ] NO`

---

**Q10.** Freeze canonization scope before new orchestration expansion?
